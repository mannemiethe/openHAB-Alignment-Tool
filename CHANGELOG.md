...
- Renamed extension package to `oh-alignment-tool-2026` / display name `openHAB 2026 Alignment Tool` to avoid colliding with the unmaintained original Marketplace listing.
